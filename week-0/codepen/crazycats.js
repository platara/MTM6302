...
function createCat (cat) {
  ...
  const { name, size, color, age } = cat

  if (typeof name !== 'string') {
    warning.textContent = 'Name is not a string.'
  ...
  if (typeof size !== 'string' || !sizes.includes(size)) {
    warning.textContent = 'Size is not correct.'
    warning.classList.add('show')
  ...
  if (typeof color !== 'string') {
    warning.textContent = 'Color is not a string.'
    warning.classList.add('show')
  ...
  if (typeof age !== 'number') {
    warning.textContent = 'Age is not a number.'
    warning.classList.add('show')
...
create.addEventListener('click', function () {
  ...
  if (typeof cat1 !== 'undefined') {
    cats.insertAdjacentHTML(`beforeend`, createCat(cat1))
  }

  if (typeof cat2 !== 'undefined') {
    cats.insertAdjacentHTML(`beforeend`, createCat(cat2))
  }

  if (typeof cat3 !== 'undefined') {
    cats.insertAdjacentHTML(`beforeend`, createCat(cat3))
  }

  if (typeof cat4 !== 'undefined') {
    cats.insertAdjacentHTML(`beforeend`, createCat(cat4))
  }
})